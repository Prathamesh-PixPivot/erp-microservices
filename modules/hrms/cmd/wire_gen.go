...
func InitializeDependencies() (*Dependencies, error) {
	...
	hrmsGrpcHandler := InitializeGRPCServer(hrmsUsecase, logger)
	dependencies := &Dependencies{
		Config:     config,
		Logger:     logger,
		Database:   database,
		GRPCServer: hrmsGrpcHandler,
	}
...
type Dependencies struct {
	...
	GRPCServer *grpc.HrmsGrpcHandler // ✅ Fix: Use gRPC service implementation
}
...
func InitializeGRPCServer(hrmsUseCase *usecase.HrmsUsecase, logger *zap.Logger) *grpc.HrmsGrpcHandler {
