...
const (
	DesignationService_CreateDesignation_FullMethodName  = "/hrms.DesignationService/CreateDesignation"
	DesignationService_GetDesignationByID_FullMethodName = "/hrms.DesignationService/GetDesignationByID"
	DesignationService_UpdateDesignation_FullMethodName  = "/hrms.DesignationService/UpdateDesignation"
	DesignationService_DeleteDesignation_FullMethodName  = "/hrms.DesignationService/DeleteDesignation"
	DesignationService_ListDesignations_FullMethodName   = "/hrms.DesignationService/ListDesignations"
)
...
type DesignationServiceClient interface {
	...
	GetDesignationByID(ctx context.Context, in *GetDesignationRequest, opts ...grpc.CallOption) (*DesignationResponse, error)
	UpdateDesignation(ctx context.Context, in *UpdateDesignationRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
	DeleteDesignation(ctx context.Context, in *DeleteDesignationRequest, opts ...grpc.CallOption) (*EmptyResponse, error)
...
func (c *designationServiceClient) GetDesignationByID(ctx context.Context, in *GetDesignationRequest, opts ...grpc.CallOption) (*DesignationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DesignationResponse)
	err := c.cc.Invoke(ctx, DesignationService_GetDesignationByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *designationServiceClient) UpdateDesignation(ctx context.Context, in *UpdateDesignationRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *designationServiceClient) DeleteDesignation(ctx context.Context, in *DeleteDesignationRequest, opts ...grpc.CallOption) (*EmptyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EmptyResponse)
...
type DesignationServiceServer interface {
	...
	GetDesignationByID(context.Context, *GetDesignationRequest) (*DesignationResponse, error)
	UpdateDesignation(context.Context, *UpdateDesignationRequest) (*EmptyResponse, error)
	DeleteDesignation(context.Context, *DeleteDesignationRequest) (*EmptyResponse, error)
...
func (UnimplementedDesignationServiceServer) GetDesignationByID(context.Context, *GetDesignationRequest) (*DesignationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDesignationByID not implemented")
}
func (UnimplementedDesignationServiceServer) UpdateDesignation(context.Context, *UpdateDesignationRequest) (*EmptyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateDesignation not implemented")
}
func (UnimplementedDesignationServiceServer) DeleteDesignation(context.Context, *DeleteDesignationRequest) (*EmptyResponse, error) {
...
func _DesignationService_GetDesignationByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDesignationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DesignationServiceServer).GetDesignationByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DesignationService_GetDesignationByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DesignationServiceServer).GetDesignationByID(ctx, req.(*GetDesignationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DesignationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hrms.DesignationService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDesignationByID",
			Handler:    _DesignationService_GetDesignationByID_Handler,
		},
		{
	...
	Metadata: "proto/designation.proto",
}
