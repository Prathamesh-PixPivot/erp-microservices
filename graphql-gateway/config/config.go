...
func LoadConfig() (*Config, error) {
	...
	cfg.AuthServiceHost = getEnv("AUTH_SERVICE_HOST", "host.docker.internal")
	...
	cfg.UserServiceHost = getEnv("USER_SERVICE_HOST", "host.docker.internal")
	...
	cfg.OrganizationServiceHost = getEnv("ORGANIZATION_SERVICE_HOST", "host.docker.internal")
	...
	cfg.LeadServiceHost = getEnv("LEAD_SERVICE_HOST", "host.docker.internal")
	...
	cfg.OpportunityServiceHost = getEnv("OPPORTUNITY_SERVICE_HOST", "host.docker.internal")
	...
	cfg.ContactServiceHost = getEnv("CONTACT_SERVICE_HOST", "host.docker.internal")
	...
	cfg.ActivityServiceHost = getEnv("ACTIVITY_SERVICE_HOST", "host.docker.internal")
	...
	cfg.VendorServiceHost = getEnv("Vendor_HOST", "host.docker.internal")
	...
	cfg.InvoiceServiceHost = getEnv("Invoice_HOST", "host.docker.internal")
	...
	cfg.PaymentServiceHost = getEnv("Payment_HOST", "host.docker.internal")
	...
	cfg.PerformanceServiceHost = getEnv("Performance_HOST", "host.docker.internal")
	...
	cfg.PurchaseOrderServiceHost = getEnv("PurchaseOrder_HOST", "host.docker.internal")
	...
	cfg.CreditDebitNoteServiceHost = getEnv("CreditNote_HOST", "host.docker.internal")
	...
	cfg.PaymentDueServiceHost = getEnv("PaymentDue_HOST", "host.docker.internal")
	...
	cfg.LedgerServiceHost = getEnv("Ledger_HOST", "host.docker.internal")
